        ...
        >
            <section className="py-12 flex flex-col items-center text-center">
                ...
                <div className="mt-6">
                    ...
                    <p className="text-blue-400">My personal portfolio & advanced ATS checker app (not on github / <a href='https://www.cveksperi.netlify.app' rel="noopener noreferrer" target="_blank">(CV Eksperi 👈🏼)</a>) & advanced ATS CV builder app <a href='https://www.nextstepcv.site' rel="noopener noreferrer" target="_blank">(NextStepCV 👈🏼)</a></p>
                </div>
            </section>
        </motion.section>
    );
